  ...
  const requestNotificationPermission = async () => {
    if (!("Notification" in window)) {
      ...
      if (isIOS) {
        ...
        alert(
          "Trình duyệt của bạn không hỗ trợ tính năng thông báo. Hãy cài đặt ứng dụng 80others bằng cách nhấn biểu tượng tải xuống (Install) trên thanh địa chỉ trình duyệt để nhận thông điệp mỗi ngày nhé!"
        );
      }
      setIsOpen(false);
      return;
